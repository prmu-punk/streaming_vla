...
from experiments.libero.async_streaming_runtime_profiled import ProfiledRuntime  # noqa: E402
...
def run_native_async_anchor_chunk(
    *,
    ...
    # Anchor comparison is an offline replay, not a real-time rollout. Keep the
    # logical control cadence in obs timestamps, but do not sleep during env replay.
    min_step_dt_s = 0.0
