...
def main():
    print("=== 开始 RTC-flow 完整冒烟测试 ===")
    device = "cuda" if torch.cuda.is_available() else "cpu"
    print(f"使用的设备: {device}")

    # 1. 准备配置
    model_path = "/data/luye/Streaming_VLA/models/RynnBrain-2B"
    ...
    vla_config_path = "/home/luye/data/Streaming_VLA/configs/vla_qwen3_rtc.yaml"
