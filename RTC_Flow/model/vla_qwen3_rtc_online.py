...
class Qwen3RTCVLAOnlinePipeline:
    ...
    def __init__(
        ...
        *,
        ...
        self.rtc_entry = RTCVLAEntry(config_path=rtc_config_path)
        ...
        self.runner = self.rtc_entry.build_stream_runner_snapshot(
    ...
    def sample_and_schedule(
        ...
        *,
        ...
        step_id = self.pipeline_state.next_id()
        ...
        self.pipeline_state.chunk_queue.append(chunk_packet)
        popped = self.pipeline_state.pop_action_chunk()
        if popped is None:
            raise RuntimeError("RTC pipeline produced no chunk packet.")

        return {
            "step_id": popped.step_id,
            "inference_delay": popped.inference_delay,
            "execute_horizon": popped.execute_horizon,
            "action_chunk": popped.action_chunk,
            "execute_chunk": popped.execute_chunk,
        }
