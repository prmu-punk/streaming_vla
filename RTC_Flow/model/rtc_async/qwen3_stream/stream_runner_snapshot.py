...
from model.template_qwen3_vla import build_step_assistant_prefix, build_step_user_prefix
...
class Qwen3VLStreamRunnerSnapshot:
    ...
    def _forward_append(
        ...
        *,
        ...
        if input_ids is not None:
            ...
            dummy_ids = torch.full((batch_size, seq_len), self.state_token_id, device=device, dtype=torch.long)
    ...
    def append_state_tokens(
        ...
        *,
        ...
        """按时间门控追加 state embedding，返回是否实际写入。"""
        ...
        self._forward_append(inputs_embeds=inputs_embeds, attention_mask=local_mask)
