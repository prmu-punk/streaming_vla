...
class Qwen3VLModel(Qwen3VLPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        if precomputed_video_outputs is not None and pixel_values_videos is not None:
            raise ValueError("Provide either precomputed_video_outputs or pixel_values_videos, not both.")

        if precomputed_video_outputs is not None:
